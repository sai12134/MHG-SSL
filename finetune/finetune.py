...
def main():
    ...
    parser.add_argument('--lr_feat', type=float, default=0.001, help='learning rate (default: 0.001)')
    ...
    parser.add_argument('--gnn_type', type=str, default="gin", help='gnn_type (gat, gin, gcn, graphsage)')
    parser.add_argument('--dataset', type=str, default='esol',
                        help='[bace, sider,tox21, esol, freesolv,lipophilicity, qm9]')
    parser.add_argument('--input_model_file', type=str, default='../saved_model/pretrain_bfs.pth',
                        help='filename to read the model (if there is any)')
    parser.add_argument('--filename', type=str, default='', help='output filename')
    parser.add_argument('--seed', type=int, default=42, help="Seed for splitting the dataset.")
    parser.add_argument('--runseed', type=int, default=0, help="Seed for minibatch selection, random initialization.")
    parser.add_argument('--split', type=str, default="random", help="random or scaffold")
    ...
    if args.dataset in ['tox21', 'bace', 'sider']:
        task_type = 'cls'
    else:
        task_type = 'reg'
    ...
    print("model:", args.input_model_file)
